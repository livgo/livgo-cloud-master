...
public final class StringUtil {
    ...
    public static String joinString(String[] array, String symbol) {
        ...
        if (array != null) {
            ...
            if (result.length() > 1 && ValidUtil.isNotEmpty(symbol)) {
    ...
    public static String join(String linkStr, String... strs) {
        ...
        if (result.length() > 1 && ValidUtil.isNotEmpty(linkStr)) {
    ...
    public static String ltrim(String str1, int num) {
        String tt = "";
        if (ValidUtil.isNotEmpty(str1) && str1.length() >= num) {
    ...
    public static String rtrim(String str, int num) {
        if (ValidUtil.isNotEmpty(str) && str.length() > num) {
    ...
    public static boolean isIn(String substring, String[] source) {
        if (ValidUtil.isEmpty(substring) || !ValidUtil.isNotEmpty(source)) {
            return false;
        }
        for (String t : source) {
